                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <input type="hidden" id="moduleid" name="moduleid" class="form-control"
                                            value="{{ Crypt::encrypt($datamodule->pk_module_id) }}">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label for="modulename">Nama</label>
                                                    <input type="text" id="modulename" name="modulename"
                                                        class="form-control"" value="{{ $datamodule->name }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label for="moduledescription">Deskripsi</label>
                                                    <textarea rows="6" id="moduledescription" name="moduledescription" class="form-control">{{ $datamodule->description }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea type="text" rows="3" class="form-control" id="routeview" name="routeview" placeholder="Routes View">{{ $datamodule->url_view }}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="routeadd" class="col-sm-2 col-form-label">Add</label>
                                            <div class="col-sm-10">
                                                <textarea type="text" rows="3" class="form-control" id="routeadd" name="routeadd" placeholder="Routes Add">{{ $datamodule->url_add }}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="routeedit" class="col-sm-2 col-form-label">Edit</label>
                                            <div class="col-sm-10">
                                                <textarea type="text" rows="3" class="form-control" id="routeedit" name="routeedit" placeholder="Routes Edit">{{ $datamodule->url_update }}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="routedelete" class="col-sm-2 col-form-label">Delete</label>
                                            <div class="col-sm-10">
                                                <textarea type="text" rows="3" class="form-control" id="routedelete" name="routedelete"
                                                    placeholder="Routes Delete">{{ $datamodule->url_delete }}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="routedetail" class="col-sm-2 col-form-label">Detail</label>
                                            <div class="col-sm-10">
                                                <textarea type="text" rows="3" class="form-control" id="routedetail" name="routedetail"
                                                    placeholder="Routes Detail">{{ $datamodule->url_detail }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="approvaldata" name="approvaldata">
                            <input type="hidden" id="approvalid" name="approvalid" class="form-control">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Status</label>
                                        <select id="status" name="status" class="form-control select2"
                                            ...
                                            @foreach ($datanextstatus as $item)
                                                <option value='{{ encryptId($item->pk_projectmaster_id) }}'>
                                                    {{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id='roles' name="roles" multiple='multiple'>
                                            @foreach ($datarole as $item)
                                                <option value='{{ encryptId($item->pk_role_id) }}'>
                                                    {{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
        ...
        $('#save').click(function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "PUT",
                        url: "{!! route('admin.modules.update', Crypt::encrypt($datamodule->pk_module_id)) !!}",
                        data: {
                            dataform: dataform,
