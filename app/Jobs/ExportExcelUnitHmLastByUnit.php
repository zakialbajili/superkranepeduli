...
class ExportExcelUnitHmLastByUnit implements ShouldQueue
{
        ...
        try {
            ...
            $data = DB::table('tunitloghm')
                ...
                ->select([
                    ...
                    DB::raw('max(tunitloghm.hm_crane) as HM_Utama_HM_Atas'),
                    DB::raw('max(tunitloghm.hm_cabin) as HM_Tambahan_HM_Bawah')
                ])
                ->groupBy([
                    'tunitloghm.reg_date',
                    'tunit.unit_no',
